...
import 'package:planpal_frontend/screens/invited_specific_screen.dart';
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                InvitedSpecificScheduleScreen(scheduleId: scheduleId),
          ),
        );
      },
      child: Align(
        child: Stack(
          children: <Widget>[
            ...
            Positioned(
              ...
              right: 18,
              child: ClipRect(
                child: AppIcon().getFace1Icon(
                    color: AppColors.white, height: 90, width: 90),
              ),
            ),
          ],
        ),
